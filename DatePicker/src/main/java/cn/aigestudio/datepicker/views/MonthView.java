...
//        animZoomOut2 = (int) (cellW * 0.9F);
    ...
    private void drawBGToday(Canvas canvas, Rect rect) {
        ...
        canvas.drawCircle(rect.centerX(), rect.centerY(), circleRadius / 3.5F, mPaint);
    ...
    private void drawBGHoliday(Canvas canvas, Rect rect, boolean isHoliday) {
        ...
        if (isHoliday) canvas.drawCircle(rect.centerX(), rect.centerY(), circleRadius / 3.5F, mPaint);
                    ...
                    if (mDPMode == DPMode.SINGLE) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                            ...
                            ValueAnimator animScale4 =
                                    ObjectAnimator.ofInt(circle, "radius", animZoomOut2, (int)(circleRadius/1.5f));
