...
public class PageWidget extends View {
	...
	public void anim(){
		mTouch.x = mWidth *9.8f/10;
		mTouch.y = mHeight *9.8f/10;
		calcCornerXY(mTouch.x, mTouch.y);
		invalidate();
		for(float i = 9.8f;i>5f;i-=0.2f){

			mTouch.x = mWidth *i/10;
			mTouch.y = mHeight *i/10;
			invalidate();
		}
		startAnimation(1000);
		this.invalidate();
	...
	private void createDrawable() {
		int[] color = { 0xbdbdbd, 0xb0bdbdbd };
//		int[] color = { 0xffffff, 0xffffff };
